...
require_once __DIR__ . '/../jwt/jwt.middleware.php';
...
class Router {
    ...
    public function route($url, $verb){
        ...
        $url = trim($url, '/');
        // Ejecutar middleware solo en rutas protegidas
        if (($verb == 'POST' && $url == 'libros') || ($verb == 'PUT' && strpos($url, 'libros/') === 0) || ($verb == 'DELETE' && strpos($url, 'libros/') === 0)){
